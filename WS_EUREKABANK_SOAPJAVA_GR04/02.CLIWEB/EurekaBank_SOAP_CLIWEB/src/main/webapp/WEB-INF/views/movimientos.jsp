                    ...
                    <tbody>
                        <%
                            for (Movimiento m : movimientos) {
                                ...
                                if (m.getTipo().toLowerCase().contains("dep")) {
                                    badgeClass += " badge-deposito";
                                } else if (m.getTipo().toLowerCase().contains("ret")) {
                        ...
                        <tr>
                            ...
                            <td><%= m.getFecha() %></td>
                            <td><span class="<%= badgeClass %>"><%= m.getTipo() %></span></td>
                            <td><%= m.getAccion() %></td>
                            <td><strong>$<%= String.format("%.2f", m.getImporte()) %></strong></td>
                        </tr>
                        <% } %>
                    </tbody>
                </table>
