...
<head>
    ...
    <style>
        * {
        ...
        .confetti:nth-child(2n) { background: #c00000; }
        .confetti:nth-child(3n) { background: #0052a3; }
        .confetti:nth-child(4n) { background: #f4d03f; }
...
<div class="modal-overlay">
    <div class="modal">
        ...
        <div class="help-message">
            ...
            <span>Por favor, verifique los datos ingresados e intente nuevamente.</span>
        </div>
        <% } %>
    </div>
</div>
