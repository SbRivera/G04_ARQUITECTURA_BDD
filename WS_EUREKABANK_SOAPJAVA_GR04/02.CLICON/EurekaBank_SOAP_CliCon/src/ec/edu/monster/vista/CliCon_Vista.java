        ...
        if (USUARIO.equals(usuario) && PASS.equals(password)) {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    int estado = controlador.regDeposito(cuentaDeposito, importe);
                    if (estado == 1) {
                ...
                case 3:
                    ...
                    int estadoretiro = controlador.regRetiro(cuentaRetiro, importeRetiro);
                    if (estadoretiro == 1) {
                ...
                case 4:
                    ...
                    int estadoTransferencia = controlador.regTransferencia(cuentaOrigen, cuentaDestino, importeTransferencia);
