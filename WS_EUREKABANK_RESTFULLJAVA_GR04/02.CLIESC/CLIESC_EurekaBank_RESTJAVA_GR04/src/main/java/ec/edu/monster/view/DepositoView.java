...
public class DepositoView extends JDialog {
  ...
  private final PrimaryButton btn = new PrimaryButton("DEPOSITAR");

  public DepositoView(Window owner){
    super(owner, "Depósito", ModalityType.APPLICATION_MODAL);
    ...
    JLabel title = new JLabel("Depósito"); title.setFont(Theme.H1); title.setForeground(Theme.TEXT_MAIN);
    card.add(title,c);
